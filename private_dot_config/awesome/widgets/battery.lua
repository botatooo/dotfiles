...
local function worker(user_args)
    ...
    local warning_msg_icon = args.warning_msg_icon or icon("status", "battery-caution")
    ...
    function(widget, stdout)
        ...
        for s in stdout:gmatch("[^\r\n]+") do
            ...
            if (status ~= nil and charge_str ~= "0") then -- dumb logitech mouse dongle always reports battery as 0% when the mouse is conncted
