...
local volume_widget = require("widgets.volume-control")

local icon = require("utils.icons")

volume = volume_widget {device="pulse"}

mylauncher = awful.widget.button({ image = icon("places", "start-here") })
mylauncher:connect_signal("button::press", function (c) awful.util.spawn("rofi -modi drun -show drun -show-icons -theme Arc-Dark --width 22", false) end)
...
root.buttons(gears.table.join(
    awful.button({ }, 3, function () awful.util.spawn("rofi -show drun -show-icons -theme Arc-Dark --width 22", false) end),
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, shift}, "z",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey, shift}, "x",  awful.tag.viewnext,
    ...
    -- apps
    awful.key({alt}, "q", function() awful.spawn("firefox-developer-edition", false) end),
    awful.key({alt, shift}, "q", function() awful.spawn("chromium", false) end),
    awful.key({alt}, "d", function() awful.spawn("discord", false) end),
    awful.key({alt}, "c", function() awful.spawn("codium", false) end),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Up",      function (c) c:move_to_screen()               end,
